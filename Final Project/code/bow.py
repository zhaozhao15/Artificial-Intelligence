...
classifier = SVC().fit(X_train_termcounts,Y_train)
Y_predict = classifier.predict(X_test_termcounts)
accuracy_score(Y_test,Y_predict)

classifier = RandomForestClassifier().fit(X_train_termcounts,Y_train)
Y_predict = classifier.predict(X_test_termcounts)
accuracy_score(Y_test,Y_predict)

classifier = GradientBoostingClassifier().fit(X_train_termcounts,Y_train)
Y_predict = classifier.predict(X_test_termcounts)
accuracy_score(Y_test,Y_predict)
