...
classifier = LogisticRegression().fit(X_train_tfidf,Y_train)
Y_predict = classifier.predict(X_test_tfidf)
accuracy_score(Y_test,Y_predict)

classifier = SVC().fit(X_train_tfidf,Y_train)
Y_predict = classifier.predict(X_test_tfidf)
accuracy_score(Y_test,Y_predict)

classifier = RandomForestClassifier().fit(X_train_tfidf,Y_train)
Y_predict = classifier.predict(X_test_tfidf)
accuracy_score(Y_test,Y_predict)
